...
![](https://andrewbatran.com/ewa/cops/cops1.png)
...
![](https://andrewbatran.com/ewa/cops/cops2.png)
...
Note that the data published by the Sun Sentinel simplifies the work they had to do, including measuring the distance between toll stations and filtering out irrelevant data. And of course, the [massive legal fight](https://www.ire.org/blog/ire-news/2013/04/15/how-sun-sentinel-reported-its-pulitzer-prize-winni/) to get the data.

The data for this exercise includes all published records from [the Sentinel database](https://databases.sun-sentinel.com/news/broward/ftlaudCopSpeeds/ftlaudCopSpeeds_list.php) that relate to the [Miami Police](https://databases.sun-sentinel.com/news/broward/ftlaudCopSpeeds/ftlaudCopSpeeds_list.php?q=%28Agency~equals~Miami+PD%29) – roughly 27,000 rows. It's been modified so that you have to recreate the average speed value yourself.
...
Also, can we find [the transponder that belongs to the trooper](https://www.ire.org/blog/ire-news/2013/04/15/how-sun-sentinel-reported-its-pulitzer-prize-winni/) described here:
...
* Data from SunPass [[download]](https://andrewbatran.com/au-2018/slides/class6/sun_sentinel/transponders.csv)

* Data on distances between toll plazas compiled by reporters [[download]](https://andrewbatran.com/au-2018/slides/class6/sun_sentinel/distances.csv)

### How do you calculate speed?

![](https://andrewbatran.com/ewa/cops/cops3.gif)
...
![](https://andrewbatran.com/ewa/cops/cops4.png)
...
![](https://andrewbatran.com/ewa/cops/cops5.png)
...
![](https://andrewbatran.com/ewa/cops/cops6.png)
...
![](https://andrewbatran.com/ewa/cops/cops7.png)
...
![](https://andrewbatran.com/ewa/cops/cops8.png)
...
![](https://andrewbatran.com/ewa/cops/cops9.png)
...
![](https://andrewbatran.com/ewa/cops/cops10.png)
...
![](https://andrewbatran.com/ewa/cops/cops11.png)
...
![](https://andrewbatran.com/ewa/cops/cops12.png)
...
![](https://andrewbatran.com/ewa/cops/cops13.png)
