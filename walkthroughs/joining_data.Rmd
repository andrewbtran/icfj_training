...
Let's start out with this [index_match.xlsx](https://andrewbatran.com/ewa/index_match.xlsx) so we have something simple to work with.
...
![](https://andrewbatran.com/ewa/joining_data/index1.png)
...
![](https://andrewbatran.com/ewa/joining_data/index2.png)

Now select the lookup_value, which in this instance will be New York. Select C2.

![](https://andrewbatran.com/ewa/joining_data/index3.png)
...
![](https://andrewbatran.com/ewa/joining_data/index4.png)
...
![](https://andrewbatran.com/ewa/joining_data/index5.png)
...
![](https://andrewbatran.com/ewa/joining_data/index6.png)
...
![](https://andrewbatran.com/ewa/joining_data/index7.png)
...
![](https://andrewbatran.com/ewa/joining_data/index8.png)
...
![](https://andrewbatran.com/ewa/joining_data/index9.png)
...
![](https://andrewbatran.com/ewa/joining_data/index10.png)



If it worked correctly, you'll have the number of row where it matches in the second table.

![](https://andrewbatran.com/ewa/joining_data/index11.png)
...
![](https://andrewbatran.com/ewa/joining_data/index12.png)

Make sure you add the anchors and apply the formula to the other cells.



![](https://andrewbatran.com/ewa/joining_data/index13.png)
